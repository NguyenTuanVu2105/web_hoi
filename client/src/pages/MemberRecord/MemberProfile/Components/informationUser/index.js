...
const InformationUser = (props) => {
    const { sttv, hovaten, ngaysinh, gioitinh, giotmau, image, SolanHM, Nhommau, rhD, donvi, donvicuthe, doanviendangvien, trinhdohocvan, email, sdt, cmtorhc, linkfb, diachi } = props
                    ...
                    <div className="box-border-member">
                        <div className="box-avatar" id="image_infor" >
                            <div
                                ...
                                onMouseEnter={() => { setAnimateChangeAvatar(1) }}
                                onMouseLeave={() => { setAnimateChangeAvatar(0) }}
                            >
                                <Avatar
                                    size={125}
                                    src={avatar}
                        ...
                        <div className="box-content-member">
                            ...
                            <div className="box-infor-member-1">
                                ...
                                <div className = "box-value-member">
                                    <a style={{color: "rgba(0, 0, 0, 0.65)"}} href={linkfb} target="_blank" >{linkfb}</a>
                                </div>
                            </div>
                            <div className="box-infor-member-1">
                                <div className="box-svg-member">
