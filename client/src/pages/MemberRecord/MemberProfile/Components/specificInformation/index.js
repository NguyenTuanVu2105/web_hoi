...
const SpecificInformation= (props) => {
    const {donvi, donvicuthe, doanviendangvien, trinhdohocvan, quequan, thongtinlienheGD, ghichu} = props

    return (
        <div className = "box-para-speinfo">
            <div className = "box-header-speinfo">
                Thông tin chi tiết 
            </div>
            <div className = "box-body-speinfo">
                <div className="box-content-speinfo">
                    <div className="label-speinfo">
                        Đơn vị học tập/Công tác:
                    </div>
                    <div className="value-speinfo">
                        {donvi}
                    </div>
                </div>
                <div className="box-content-speinfo">
