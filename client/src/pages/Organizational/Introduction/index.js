...
const Introduction = (props) => {
  ...
  const handleUpdate = (e) => {
    ...
    props.form.validateFields(async (err, values) => {
      if (!err) {
        setLoading(true);
        const { success } = await Association.editAssociation(values);
        setLoading(false);
        if (success) {
  ...
  const fetchData = async () => {
    const result = await Association.getAssociation();
    if (result.success) {
  ...
  return (
    <div className="para-container-intro-s">
        ...
        <div className="content-header">
          <div
            style={{
              marginRight: 10,
              fontWeight: 500,
              color: visibleIntro ? "#ff4d4d" : "rgba(0, 0, 0, 0.65)",
            }}
            onClick={() => setVisibleIntro(true)}
          >
            <a>Hội máu Hà Nội</a>
          </div>
          <div
            style={{
              marginRight: 10,
              fontWeight: 500,
              color: visibleIntro ? "rgba(0, 0, 0, 0.65)" : "#ff4d4d",
            }}
            onClick={() => setVisibleIntro(false)}
          >
            <a>Hoạt động và khen thưởng</a>
          </div>
        </div>
      </div>
      {/* Hội máu Hà Nội */}
      <Form onSubmit={handleUpdate}>
        <div
          className="body-intro-blood-s"
          style={{ display: visibleIntro ? "flex" : "none" }}
        >
            ...
            <div style={{ width: "100%", display: "flex", flexWrap: "wrap" }}>
              <div className="logo-intro-reponsive">
                ...
                <div className="intro-tag-a-rp">
                  <a className="h4-a-IB" href="/gioi-thieu-ve-hoi-chi-tiet">
                    Hội máu Hà Nội
                  </a>
                </div>
              </div>
              <div className="thuong-truc-s">
                ...
                <div>
                  <div className="list-name-intro">
                    ...
                    <span
                      style={{ width: "auto", height: 30, lineHeight: "30px" }}
                    >
                      <div
                        style={{ display: changeInputIB ? "block" : "none" }}
                      >
                        <label style={{ color: "rgba(0, 0, 0, 0.65)" }}>
                          {association.Chutichhoi}
                        </label>
                      </div>
                      <div
                        style={{ display: changeInputIB ? "none" : "block" }}
                      >
                        <Form.Item>
                ...
                <div className="unit-column-infor">
                  <div className="unit-div-infor">
                    ...
                    <div className="unit-div2-infor">
                      <div
                        style={{
                          display: changeInputIB ? "flex" : "none",
        ...
        <div
          className="body-intro-blood-s"
          style={{ display: visibleIntro ? "none" : "flex" }}
        >
          <div className="red-left-body" />
          <div className="content-body-intro">
            <IntroUnit />
...
export default Form.create()(Introduction);
