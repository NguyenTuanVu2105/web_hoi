    ...
    <div className="para-header-s-0">
      ...
      <div style={{ display: background.length ? "none" : "block" }}>
        <div className="page-header">
          <div className="reponsive-header">
            <img
              className="background-cover-header"
              src="/img/backgroundlogo.png"
            />
          </div>
        </div>
      </div>
        ...
        <div className="content-header-s" style={{ height: "175px" }}>
          <div className="body-text-header-s">
            <div className="text-header-s">
              <a href="/gioi-thieu-ve-hoi" className="tag-a-header-s">
                Giới thiệu về Hội
              </a>
            </div>
          </div>
          <div className="body-text-header-s">
            <div className="text-header-s">
              <a href="/ho-so-don-vi" className="tag-a-header-s">
                Đơn vị trực thuộc
              </a>
            </div>
          </div>
          <div className="body-text-header-s">
            <div className="text-header-s">
              <a href="/lich-su-hoi" className="tag-a-header-s">
                Lịch sử Hội
              </a>
            </div>
          </div>
          <div className="body-text-header-s">
            <div className="text-header-s">
              <a
                href="https://www.facebook.com/groups/Giadinhhoimau/"
                target="_blank"
                className="tag-a-header-s"
              >
                Gia đình Hội Máu
              </a>
            </div>
        ...
        <div className="content-header-s" style={{ height: "65px" }}>
          ...
          >
            <a
              ...
              href="https://www.facebook.com/hoimauhanoi/"
              target="_blank"
            ...
            >
              ...
              <div className="icon-header-s" style={{ paddingTop: "4.5px" }}>
                <i
                  className="fa fa-facebook-f"
                  style={{ fontSize: 34, color: "#4267b2" }}
                />
              </div>
            </a>
          </div>
